 ...
 * @param {Object} str String der mit dem Basisstring verglichen wird
 */
 ...
 * @param {Integer} index Index an dem value eingef�gt wird
 * @param {Object} value Das Objekt welches eingef�gt werden soll
 */
 ...
 * @param {Object} obj �berpr�ft ob obj vorhanden ist
 */
...
Ext.override(Ext.grid.GridView, {
	// private
	// Nur grid als Uebergabeparameter fuer den renderer hinzugefuegt
	doRender: function (cs, rs, ds, startRow, colCount, stripe) {
		...
		for (var j = 0, len = rs.length; j < len; j++) {
			...
			for (var i = 0; i < colCount; i++) {
				...
				// ****** Aenderung start - this.grid hinzugefuegt
...
/**
 * Check wheter the event objects are corresponding with the lesson objects (doz, room, clas)
 * @author Wolf
 * @param {Array} event An Array which represent an event
 * @param {Array} arr An Array which contains all lesson on one day
 * @param {String} selectedScheduleid The id of the current selected schedule
 * @return (Integer) Returns one of the following numbers 1: selectedScheduleid is the same as one of the event objects
 *														  2: A class of an element in arr is the same as one of the event objects
 *														  3: A lecturer of an element in arr is the same as one of the event objects
 *														  4: A room of an element in arr is the same as one of the event objects
 * 														  0: No condition above is true
 */
 ...
 * @param {Array} arr Array of lecturers, rooms or classes of a lesson
 * @return {Boolean} true if an element in arr matches to obj
 *                   false if no elmenet in arr matches to obj
 */
 ...
 * @author Wolf
 * @param {Integer} number The number of the weekday
 * @return {String} english weekday between sunday (0) and saturday (6) (include monday and friday)
 *                  {Boolean} false if the number is not between 0-6 (include 0 and 6)
 */
