...
function addNewEvent(eventid, sdate, stime, etime) {
	...
	var win = new Ext.Window({
		...
		modal: true,
		closeAction: 'close',
		//src:'http://localhost/joomla/index.php?option=com_giessenscheduler&view=editevent&eventid='+eventid+'&tmpl=component'
		html: '<iframe onLoad="newEventonLoad(this)" id="iframeNewEvent" class="mysched_iframeNewEvent" src="http://localhost/joomla/index.php?option=com_giessenscheduler&view=editevent&eventid=' + eventid + '&tmpl=component' + adds + '"></iframe>'
		/*items:[
		 panel
		 ]*/
	});
