...
function getSchedGrid(){
	...
	var grid = Ext.create('SchedGrid', {
	    ...
	    columns: [
	        {header: 'Zeit',  dataIndex: 'time', renderer: MySched.lectureCellRenderer, sortable: false, hideable: false, width: 35},
	        {header: 'Montag',  dataIndex: 'monday', renderer: MySched.lectureCellRenderer, sortable: false, hideable: false, flex: 1},
	        {header: 'Dienstag',  dataIndex: 'tuesday', renderer: MySched.lectureCellRenderer, sortable: false, hideable: false, flex: 1},
	        {header: 'Mittwoch',  dataIndex: 'wednesday', renderer: MySched.lectureCellRenderer, sortable: false, hideable: false, flex: 1},
	        {header: 'Donnerstag',  dataIndex: 'thursday', renderer: MySched.lectureCellRenderer, sortable: false, hideable: false, flex: 1},
	        {header: 'Freitag',  dataIndex: 'friday', renderer: MySched.lectureCellRenderer, sortable: false, hideable: false, flex: 1}
	    ],
	    viewConfig: {
...
function addNewEvent(eventid, sdate, stime, etime) {
	...
	if (typeof datemenu.menu == "undefined")
		weekpointer = datemenu.initialConfig.value;
	else
		weekpointer = datemenu.menu.picker.activeDate;
