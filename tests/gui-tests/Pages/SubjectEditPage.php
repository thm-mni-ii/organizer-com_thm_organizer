 ...
 */
class SubjectEditPage extends iCampusAdminEditPage
{
	/**
	 ...
	 * @since  3.2
	 */
	protected $url = 'administrator/index.php?option=com_thm_organizer&view=subject_edit';
	...
	public $inputFields = array (
            ...
            array('label' => 'Availability', 'id' => 'jform_frequencyID', 'type' => 'select', 'tab' => 'details'),
