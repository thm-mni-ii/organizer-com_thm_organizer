 ...
 */
class THM_OrganizerModelConsumptionSiteTest extends iCampusDatabaseTestCase {
    /**
     *
    ...
    {
        return $this->createXMLDataSet(JPATH_BASE . '/tests/com_thm_organizer/unit-tests/stubs/cimni_thm_organizer_schedules.xml');
    }
