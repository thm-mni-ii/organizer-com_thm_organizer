 ...
 *         
 */
abstract class iCampusDatabaseTestCase extends PHPUnit_Extensions_Database_TestCase {
    ...
    public static function setUpBeforeClass() {
        ...
        if (! is_object ( self::$dbo )) {
            $options = array (
                    ...
                    'user' => isset ( $config ) ? $config->user : 'root',
                    'password' => isset ( $config ) ? $config->password : '',
                    'database' => isset ( $config ) ? $config->db : 'mni',
     ...
     *
     * @param
     *            array	araay of values and options to set the handlers
     *            
     * @return void
     */
     ...
     *
     * @param
     *            JException	The JException object from JError
     *            
     * @return bool not continue with JError processing
     */
