            ...
            <div class="filter-header">
                <div class="deputat-settings">
                    <div class="deputat-settings-description">
                        <?php echo \JText::_('THM_ORGANIZER_DEPUTAT_CALCULATION_SETTINGS'); ?>
                    </div>
                    <div class="control-group">
                        <div class="control-label">
                            <?php echo \JText::_('THM_ORGANIZER_DEPUTAT_WEEKS'); ?>
                        </div>
                        <div class="controls">
                            <?php echo $weeks . ' ' . \JText::_('THM_ORGANIZER_WEEKS'); ?>
                        </div>
                    </div>
                    <div class="control-group">
                        <div class="control-label">
                            <?php echo \JText::_('THM_ORGANIZER_BACHELOR_VALUE'); ?>
                        </div>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <div class="control-label">
                            <?php echo \JText::_('THM_ORGANIZER_MASTER_VALUE'); ?>
                        </div>
                        <div class="controls">
                ...
                <div class="selection-settings">
                    <div class="control-group">
                        <div class="control-label">
                            <label for="schedules">
                                <?php echo \JText::_('THM_ORGANIZER_DATA_SOURCE') ?>
                            </label>
                        </div>
                        <div class="controls">
                    ...
                    if (!empty($this->model->schedule)) {
                        ...
                        <div class="control-group">
                            <div class="control-label">
                                <label for="teachers">
                                    <?php echo \JText::_('THM_ORGANIZER_TEACHERS') ?>
                                </label>
                            </div>
                            <div class="controls">
                        ...
                        <div class="button-group">
                            <button type="submit">
                                <?php echo \JText::_('THM_ORGANIZER_ACTION_SHOW') ?>
