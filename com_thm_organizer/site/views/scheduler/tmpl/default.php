...
$curriculumLink = JURI::root(true) . '/index.php?option=com_thm_organizer&view=subject_details&languageTag=de&Itemid=' . JFactory::getApplication()->input->getInt("Itemid");
