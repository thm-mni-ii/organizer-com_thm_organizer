...
Ext.data.XmlReader,
{
    ...
    readRecord: function (root, def, key, records)
    {
        ...
        for (var i = 0; i < mydowarray.length; i++)
        {
            ...
            values.key = (def.subject + "_" + values.dow + "_" + values.block + "_" + lessonid)
                .toLowerCase();
    ...
    readRecords: function (doc)
    {
        ...
        // deshalb substring
        this.version = Ext.Date.parseDate(Ext.DomQuery.selectNode('document', doc)
            .getAttribute('date'), 'Ymd');
