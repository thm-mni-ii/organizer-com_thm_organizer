                ...
                this.infoWindow = Ext.create('Ext.Window',
                    {
                        ...
                        html: "<small style='float:right; font-style:italic;'>Version " + MySched.version + "</small>" + "<p style='font-weight:bold;'>Änderungen sind farblich markiert: <br /> <p style='padding-left:10px;'> <span style='background-color: #00ff00;' >Neue Veranstaltung</span></p> <p style='padding-left:10px;'><span style='background-color: #ff4444;' >Gelöschte Veranstaltung</span></p> <p style='padding-left:10px;'><span style='background-color: #ffff00;' >Geänderte Veranstatung (neuer Raum, neuer Dozent)</span> </p><p style='padding-left:10px;'> <span style='background-color: #ffaa00;' >Geänderte Veranstaltung (neue Zeit:von)</span>, <span style='background-color: #ffff00;' >Geänderte Veranstaltung (neue Zeit:zu)</span></p></p>" + "<b>Version: 2.1.6:</b>" + "<ul>" + "<li style='padding-left:10px;'>NEU: Hinzufügen der Veranstaltungen über Kontextmenu (Rechtsklick auf Veranstaltung).</li>" + "<li style='padding-left:10px;'>NEU: Hinzufügen von eigenen Veranstaltungen über Kontextmenu (Rechtsklick in einen Block).</li>" + "<li style='padding-left:10px;'>NEU: Navigation über den Dozent, Raum, Fachbereich einer Veranstaltung.</li>" + "<li style='padding-left:10px;'>NEU: Navigation durch einzelne Wochen über einen Kalender (Menüleiste).</li>" + "<li style='padding-left:10px;'>GEÄNDERT: Anzeige von Terminen.</li>" + "<li style='padding-left:10px;'>GEÄNDERT: Informationen zu Terminen über Termintitel (Mauszeiger über Titel).</li>" + "<li style='padding-left:10px;'>GEÄNDERT: Informationen zu Veranstaltungen über Veranstaltungstitel (Klick auf den Titel).</li>" + "</ul>" + "<br/>" + "<b>Version: 2.1.5:</b>" + "<ul>" + "<li style='padding-left:10px;'>NEU: Persönliche Termine können über den Menüpunkt 'Neuer Termin' oder per Klick in einen Block angelegt werden.</li>" + "<li style='padding-left:10px;'>NEU: Berechtigte Benutzer dürfen im Panel 'Einzel Termine' neue Termine anlegen oder alte editieren.</li>" + "<li style='padding-left:10px;'>GEÄNDERT: Änderungen werden wie ein Stundenplan aufgerufen.</li>" + "<li style='padding-left:10px;'>GEÄNDERT: Nur registrierte Benutzer haben Zugriff auf alle Funktionen.</li>" + "</ul>" + "<br/>" + "<b>Version: 2.1.4:</b>" + "<li style='padding-left:10px;'>NEU: In der Infoanzeige von Veranstaltungen kann die Modulbeschreibung abgerufen werden.</li>" + "<li style='padding-left:10px;'>GEÄNDERT: Termine werden nur noch an betroffenen Tagen angezeigt.</li>" + "<li style='padding-left:10px;'>GEÄNDERT: Termine werden bei Klick auf das orangene Ausrufezeichen angezeigt.</li>" + "<br/>" + "<b>Version: 2.1.3:</b>" + "" + "<li style='padding-left:10px;'>NEU: Stundenpläne können als Terminkalendar heruntergeladen werden. (Menüpunkt ICS Download)</li>" + "<li style='padding-left:10px;'>NEU: Navigationsleiste kann eingeklappt werden.</li>" + "<li style='padding-left:10px;'>NEU: Veranstaltungen können per Doppelklick hinzugefügt / entfernt werden.</li>" + "<li style='padding-left:10px;'>NEU: Bei Änderungen zu Ihrem abgespeicherten Plan werden jetzt sinnvolle Vorschläge gemacht.</li>" + "<li style='padding-left:10px;'>NEU: Kontrastreiche Menüs, sinnvollere Neuanordnung des Menüs.</li>" + "<li style='padding-left:10px;'>NEU: Seitentitel auch als Titel des pdf-download.</li>" + "<li style='padding-left:10px;'>NEU: Kleinere Texte bei den Einzelterminen.</li>" + "<br/>" + "<b>Version: 2.1.2:</b>" + "" + "<li style='padding-left:10px;'>NEU: MNI Style</li>" + "<li style='padding-left:10px;'>GEÄNDERT: PDF Download und PDF Dateiname bezieht sich auf den aktiven Tab</li>"
                    });
