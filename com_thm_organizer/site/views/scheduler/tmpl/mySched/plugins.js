Ext.define('Ext.ux.FitToParent', {
	...
	init : function(c) {
		...
		c.on('render', function(c) {
			this.parent = Ext.get(this.parent
	...
	fitSize : function() {
		var pos = this.component.getPosition(true), size = this.parent
				.getViewSize();
		this.component.setSize(this.fitWidth ? size.width - pos[0]
				- this.offsets[0] : undefined, this.fitHeight ? size.height
