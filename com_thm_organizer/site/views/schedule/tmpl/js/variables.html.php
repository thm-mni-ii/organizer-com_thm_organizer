<script type="text/javascript">
	...
	variables.auth = "<?php echo !empty(JFactory::getUser()->id) ?
		urlencode(password_hash(JFactory::getUser()->email . JFactory::getUser()->registerDate, PASSWORD_BCRYPT))
		: ''; ?>";
	...
	variables.menuID = <?php echo isset($_GET['Itemid']) ? $_GET['Itemid'] : 0; ?>;
	...
	variables.showRoomTypes = "<?php echo $this->model->params['showRoomTypes']; ?>";
