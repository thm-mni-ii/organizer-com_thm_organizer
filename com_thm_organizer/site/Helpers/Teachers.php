...
class Teachers
{
    ...
    {
        $dbo     = \Factory::getDbo();
        $teacher = new \Organizer\Tables\Teachers($dbo);
    ...
    public static function getIDFromScheduleData($gpuntisID, $data)
    {
        ...
        $teacherTable = new \Organizer\Tables\Teachers($dbo);
        $loadCriteria = [];
    ...
    public static function getPlanTeachers()
    {
        ...
        foreach ($teacherIDs as $teacherID) {
            $teachers[Teachers::getLNFName($teacherID)] = $teacherID;
        }
    ...
    private static function validateIndividual(&$scheduleModel, &$teacherNode)
    {
        ...
        $teacher->id = Teachers::getIDFromScheduleData($teacherID, $teacher);
