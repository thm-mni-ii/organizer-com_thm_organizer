...
class Access
{
	...
	public static function allowParticipantAccess($participantID, $courseID = 0)
	{
		...
		if (self::isAdmin() or $user->id == $participantID)
		{
			return true;
		}
	...
	public static function allowSubjectAccess($subjectID)
	{
		...
		if (empty($subjectID) or !self::checkAssetInitialization('subject', $subjectID))
		{
			return self::allowDocumentAccess();
		}

		if (self::allowDocumentAccess('subject', $subjectID))
		{
			return true;
		}
