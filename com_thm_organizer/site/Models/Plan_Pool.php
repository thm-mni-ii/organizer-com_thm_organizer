 ...
 */
class Plan_Pool extends MergeModel
{
    ...
    protected function allowEdit()
    {
        ...
        return Plan_Pools::allowEdit($allIDs);
    }
    ...
    public function batch()
    {
        ...
        if (!Plan_Pools::allowEdit($pPoolIDs)) {
    ...
    private function savePublishing($pPoolID)
    {
        ...
        if (!empty($formData['publishing'])) {
            foreach ($formData['publishing'] as $periodID => $publish) {
                $table = OrganizerHelper::getTable('Plan_Pool_Publishing');
