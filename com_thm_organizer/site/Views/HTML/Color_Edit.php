 ...
 */
class Color_Edit extends EditView
{
    /**
    ...
    protected function addToolBar()
    {
        ...
        $toolbar->appendButton('Standard', 'apply', $applyText, 'color.apply', false);
        $toolbar->appendButton('Standard', 'save', Languages::_('THM_ORGANIZER_SAVE'), 'color.save', false);
        $cancelText = $new ? Languages::_('THM_ORGANIZER_CANCEL') : Languages::_('THM_ORGANIZER_CLOSE');
        $toolbar->appendButton('Standard', 'cancel', $cancelText, 'color.cancel', false);
    }
}
