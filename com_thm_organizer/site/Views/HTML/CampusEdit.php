...
class CampusEdit extends EditView
{
	...
	protected function addToolBar()
	{
		...
		$title = $new ? Languages::_('THM_ORGANIZER_CAMPUS_NEW') : Languages::_('THM_ORGANIZER_CAMPUS_EDIT');
		HTML::setTitle($title, 'location');
		$toolbar = Toolbar::getInstance();
		$toolbar->appendButton('Standard', 'save', Languages::_('THM_ORGANIZER_SAVE'), 'campuses.save', false);
