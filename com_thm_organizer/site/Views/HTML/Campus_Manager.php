 ...
 */
class Campus_Manager extends ListView
{
    /**
    ...
    {
        HTML::setTitle(Languages::_('THM_ORGANIZER_CAMPUS_MANAGER'), 'location');
    ...
    protected function preProcessItems()
    {
        ...
        foreach ($this->items as $item) {
            ...
            $processedItems[$index]['location'] = Campuses::getPin($item->id);
