...
2006.05.18
    ...
    - these modifications do not affect the main class behavior, they are used for further developement and class extensions
*/

require_once(B.'/fpdf/table/fpdf.php');
require_once(B.'/fpdf/table/class.string_tags.php');
