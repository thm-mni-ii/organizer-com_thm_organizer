...
class THM_OrganizerModelRoom_Display extends JModelLegacy
{
	...
	private function setDisplayParams()
	{
		...
		{
			$this->params['display']          = JComponentHelper::getParams('com_thm_organizer')->get('display', SCHEDULE);
			$this->params['schedule_refresh'] = JComponentHelper::getParams('com_thm_organizer')->get('schedule_refresh', 60);
			$this->params['content_refresh']  = JComponentHelper::getParams('com_thm_organizer')->get('content_refresh', 60);
