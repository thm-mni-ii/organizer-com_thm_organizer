 ...
 * @name		THM_OrganizersModelMajor
 * @description THM_OrganizersModelMajor component admin model
...
/**
 * Class THM_OrganizersModelMajor for component com_thm_organizer
 *
 ...
 * @since       v1.5.0
 */
class THM_OrganizersModelMajor extends JModelAdmin
{
	/**
