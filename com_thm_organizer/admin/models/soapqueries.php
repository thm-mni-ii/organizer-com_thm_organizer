 ...
 * @name		THM_OrganizersModelSoapqueries
 * @description THM_OrganizersModelSoapqueries component admin model
...
/**
 * Class THM_OrganizersModelSoapqueries for component com_thm_organizer
 *
 ...
 * @since       v1.5.0
 */
class THM_OrganizersModelSoapqueries extends JModelList
{
	/**
	 * Database
	 *
