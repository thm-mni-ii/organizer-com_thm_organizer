...
var MooRainbow = new Class({
    options: {
        id: 'mooRainbow',
        prefix: 'moor-',
        imgPath: 'administrator/components/com_thm_organizer/models/fields/images/',
        startColor: [255, 0, 0],
        wheel: false,
        onComplete: $empty,
        onChange: $empty
    ...
    manualSet: function(color, type)
    {
        ...
        if (type === 'rgb')
        {
            rgb = color; hsb = color.rgbToHsb(); hex = color.rgbToHex();
        }
        else if (type === 'hsb')
        {
            hsb = color; rgb = color.hsbToRgb(); hex = rgb.rgbToHex();
        }
        else
        {
            hex = color; rgb = color.hexToRgb(true);
            hsb = rgb.rgbToHsb();
        }
    ...
    setMooRainbow: function(color, type)
    {
        ...
        {
            hex = color; rgb = color.hexToRgb(); hsb = rgb.rgbToHsb();
        }
