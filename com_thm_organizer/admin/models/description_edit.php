...
class thm_organizersModeldescription_edit extends JModelAdmin
{
	 ...
	 * delete
	 * 
	 * deletes the description specified by id
	 ...
	 * @since	2.5
	 */
	public function getTable($type = 'descriptions', $prefix = 'thm_organizerTable', $config = array()) 
	{
	...
	{
		// Get the form.
		$form = $this->loadForm('com_thm_organizer.description_edit', 'description_edit',
