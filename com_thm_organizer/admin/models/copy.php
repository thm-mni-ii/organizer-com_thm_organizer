 ...
 * @name		THM_OrganizersModelCopy
 * @description THM_OrganizersModelCopy component admin model
...
/**
 * Class THM_OrganizersModelCopy for component com_thm_organizer
 *
 ...
 * @since       v1.5.0
 */
class THM_OrganizersModelCopy extends JModelAdmin
{
	/**
