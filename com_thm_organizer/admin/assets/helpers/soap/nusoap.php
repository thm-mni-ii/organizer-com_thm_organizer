...
/*
  $Id: nusoap.php 3035 2011-01-21 09:32:19Z m.baier $
 ...
 * @version  $Id: nusoap.php 3035 2011-01-21 09:32:19Z m.baier $
 * @access   public
 */
class nusoap_base
{
...
class nusoap_parser extends nusoap_base
{
    ...
    {
        $pos = $this->depth_array[$this->depth];
        if ($this->xml_encoding == 'UTF-8' AND $this->decode_utf8)
        {
...
class nusoap_client extends nusoap_base
{
    ...
    {
        $randomInt = rand();
        $evalStr = $this->_getProxyClassCode($randomInt);
        if ($this->getError())
        {
        ...
        $proxyClassName = "nusoap_proxy_$randomInt";
