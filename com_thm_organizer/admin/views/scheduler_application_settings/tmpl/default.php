...
<div class="col100">
	<fieldset class="adminform">
		<legend><?php echo JText::_( "COM_THM_ORGANIZER_SAS_MENU_LABEL_GENERAL" ); ?></legend>
		<table class="admintable">
			<tr>
				<td class="key">
					<label for="scheduler_downFolder"><?php echo JText::_( "COM_THM_ORGANIZER_SAS_LABEL_DOWN_FOLDER" ); ?></label>
				</td>
				<td>
			...
			<tr>
				<td class="key">
					<label for="scheduler_vacationcat"><?php echo JText::_( "COM_THM_ORGANIZER_SAS_LABEL_VACATION_CATEGORY" ); ?></label>
				</td>
				<td>
	...
	<fieldset class="adminform">
		...
		<table class="admintable">
			<tr>
				<td class="key">
					<label for="scheduler_eStudyPath"><?php echo JText::_( "COM_THM_ORGANIZER_SAS_LABEL_PATH" ); ?></label>
				</td>
				<td>
			...
			<tr>
				<td class="key">
					<label for="scheduler_eStudywsapiPath"><?php echo JText::_( "COM_THM_ORGANIZER_SAS_LABEL_WSAPI_PATH" ); ?></label>
				</td>
				<td>
			...
			<tr>
				<td class="key">
					<label for="scheduler_eStudyCreateCoursePath"><?php echo JText::_( "COM_THM_ORGANIZER_SAS_LABEL_CREATE_COURSE_PATH" ); ?></label>
				</td>
				<td>
			...
			<tr>
				<td class="key">
					<label for="scheduler_eStudySoapSchema"><?php echo JText::_( "COM_THM_ORGANIZER_SAS_LABEL_SOAP_SCHEMA" ); ?></label>
				</td>
				<td>
