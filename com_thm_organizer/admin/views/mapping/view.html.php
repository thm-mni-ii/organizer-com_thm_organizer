 ...
 * @name		THM_OrganizersViewMapping
 * @description THM_OrganizersViewMapping component admin view
...
/**
 * Class THM_OrganizersViewMapping for component com_thm_organizer
 *
 ...
 * @since       v1.5.0
 */
class THM_OrganizersViewMapping extends JView
{
	/**
