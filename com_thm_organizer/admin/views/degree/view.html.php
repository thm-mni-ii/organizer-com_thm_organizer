 ...
 * @name		THM_OrganizersViewDegree
 * @description THM_OrganizersViewDegree component admin view
...
/**
 * Class THM_OrganizersViewDegree for component com_thm_organizer
 *
 ...
 * @since       v1.5.0
 */
class THM_OrganizersViewDegree extends JView
{
	/**
