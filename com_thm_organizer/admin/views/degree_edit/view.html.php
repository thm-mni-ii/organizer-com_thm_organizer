...
class THM_OrganizerViewDegree_Edit extends THM_OrganizerViewEdit
{
    ...
    protected function addToolBar()
    {
        ...
        if ($this->form->getValue('id') == 0) {
            \JToolbarHelper::title(Languages::_('THM_ORGANIZER_DEGREE_EDIT_NEW_TITLE'), 'organizer_degrees');
            \JToolbarHelper::cancel('degree.cancel', 'JTOOLBAR_CANCEL');
        } else {
            \JToolbarHelper::title(Languages::_('THM_ORGANIZER_DEGREE_EDIT_EDIT_TITLE'), 'organizer_degrees');
