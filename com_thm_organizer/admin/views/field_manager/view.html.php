...
class THM_OrganizerViewField_Manager extends THM_OrganizerViewList
{
    ...
    {
        \JToolbarHelper::title(Languages::_('THM_ORGANIZER_FIELD_MANAGER_VIEW_TITLE'), 'organizer_fields');
        \JToolbarHelper::addNew('field.add');
        \JToolbarHelper::editList('field.edit');
        \JToolbarHelper::custom('field.mergeView', 'attachment', 'attachment', 'THM_ORGANIZER_ACTION_MERGE', true);
        \JToolbarHelper::deleteList('THM_ORGANIZER_ACTION_DELETE_CONFIRM', 'field.delete');
