 ...
 * @name        THM_OrganizerViewPlan_Pool_Merge
...
/**
 * Class provides functions for merging plan_pool entries
 *
...
class THM_OrganizerViewPlan_Pool_Merge extends THM_OrganizerViewForm
{
	...
	protected function addToolBar()
	{
		...
		JToolbarHelper::custom('plan_pool.merge', 'merge', 'merge', 'COM_THM_ORGANIZER_ACTION_MERGE', false);
