 ...
 */
class THM_OrganizerViewPlan_Pool_Merge extends THM_OrganizerViewMerge
{
    /**
    ...
    protected function addToolBar()
    {
        ...
        \JToolbarHelper::custom('plan_pool.merge', 'attachment', 'attachment', 'THM_ORGANIZER_ACTION_MERGE', false);
