 ...
 * @name		THM_OrganizersViewLecturer
 * @description THM_OrganizersViewLecturer component admin view
...
/**
 * Class THM_OrganizersViewLecturer for component com_thm_organizer
 *
 ...
 * @since       v1.5.0
 */
class THM_OrganizersViewLecturer extends JView
{
	/**
