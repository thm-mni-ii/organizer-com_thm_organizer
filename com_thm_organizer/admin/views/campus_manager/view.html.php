...
class THM_OrganizerViewCampus_Manager extends THM_OrganizerViewList
{
    ...
    {
        \JToolbarHelper::title(Languages::_('THM_ORGANIZER_CAMPUS_MANAGER_VIEW_TITLE'), 'organizer_campuses');
        \JToolbarHelper::addNew('campus.add');
        \JToolbarHelper::editList('campus.edit');
        \JToolbarHelper::deleteList('THM_ORGANIZER_ACTION_DELETE_CONFIRM', 'campus.delete');
