 ...
 * @name        THM_OrganizerViewField_Merge
...
/**
 * Class provides functions for merging field entries
 *
...
class THM_OrganizerViewField_Merge extends THM_OrganizerViewForm
{
    ...
    protected function addToolBar()
    {
        ...
        JToolbarHelper::custom('field.merge', 'merge', 'merge', 'COM_THM_ORGANIZER_ACTION_MERGE', false);
