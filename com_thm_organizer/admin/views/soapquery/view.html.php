 ...
 * @name		THM_OrganizersViewSoapquery
 * @description THM_OrganizersViewSoapquery component admin view
...
/**
 * Class THM_OrganizersViewSoapquery for component com_thm_organizer
 *
 ...
 * @since       v1.5.0
 */
class THM_OrganizersViewSoapquery extends JView
{
	/**
