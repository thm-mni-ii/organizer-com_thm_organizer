 ...
 * @name		THM_OrganizersViewColor
 * @description THM_OrganizersViewColor component admin view
...
/**
 * Class THM_OrganizersViewColor for component com_thm_organizer
 *
 ...
 * @since       v1.5.0
 */
class THM_OrganizersViewColor extends JView
{
	/**
