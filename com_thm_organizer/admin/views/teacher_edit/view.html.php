...
class THM_OrganizerViewTeacher_Edit extends THM_OrganizerViewEdit
{
    ...
    protected function addToolBar()
    {
        ...
        if (empty($this->item->id)) {
            \JToolbarHelper::title(Languages::_('THM_ORGANIZER_TEACHER_EDIT_NEW_TITLE'), 'organizer_teachers');
            \JToolbarHelper::cancel('teacher.cancel', 'JTOOLBAR_CANCEL');
        } else {
            \JToolbarHelper::title(Languages::_('THM_ORGANIZER_TEACHER_EDIT_EDIT_TITLE'), 'organizer_teachers');
