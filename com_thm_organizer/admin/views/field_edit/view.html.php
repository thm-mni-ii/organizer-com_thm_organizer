...
class THM_OrganizerViewField_Edit extends THM_OrganizerViewEdit
{
    ...
    protected function addToolBar()
    {
        ...
        if (empty($this->item->id)) {
            \JToolbarHelper::title(Languages::_('THM_ORGANIZER_FIELD_EDIT_NEW_TITLE'), 'organizer_fields');
            \JToolbarHelper::cancel('field.cancel', 'JTOOLBAR_CANCEL');
        } else {
            \JToolbarHelper::title(Languages::_('THM_ORGANIZER_FIELD_EDIT_EDIT_TITLE'), 'organizer_fields');
