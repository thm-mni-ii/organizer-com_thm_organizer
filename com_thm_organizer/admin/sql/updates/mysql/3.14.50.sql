...
# region event coordinators (fk: events)
...
# region courses (make reference from units)
...
#region person groups (rename instance groups)
...
#region person rooms (rename instance rooms)
