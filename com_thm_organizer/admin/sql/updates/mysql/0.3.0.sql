...
UPDATE `#__thm_organizer_degrees` SET `abbreviation` = 'M.A.', `lsfDegree` = 'MA' WHERE `name` = 'Master of Arts';
UPDATE `#__thm_organizer_degrees` SET `abbreviation` = 'B.Eng.', `lsfDegree` = 'BE' WHERE `name` = 'Bachelor of Engineering';
UPDATE `#__thm_organizer_degrees` SET `abbreviation` = 'M.Eng.', `lsfDegree` = 'ME' WHERE `name` = 'Master of Engineering';
...
UPDATE `#__thm_organizer_fields` SET `colorID` = (SELECT `id`FROM `#__thm_organizer_colors` WHERE `color` = '032140') WHERE `field` = 'Mathematik';
UPDATE `#__thm_organizer_fields` SET `colorID` = (SELECT `id`FROM `#__thm_organizer_colors` WHERE `color` = '063d76') WHERE `field` = 'Naturwissenschaft';
UPDATE `#__thm_organizer_fields` SET `colorID` = (SELECT `id`FROM `#__thm_organizer_colors` WHERE `color` = '3d494f') WHERE `field` = 'Wirtschaft';
UPDATE `#__thm_organizer_fields` SET `colorID` = (SELECT `id`FROM `#__thm_organizer_colors` WHERE `color` = '6b7e88') WHERE `field` = 'Sozialwissenschaften' OR `field` = 'Jura';
UPDATE `#__thm_organizer_fields` SET `colorID` = (SELECT `id`FROM `#__thm_organizer_colors` WHERE `color` = 'cce3a7') WHERE `field` = 'Diverse';
UPDATE `#__thm_organizer_fields` SET `colorID` = (SELECT `id`FROM `#__thm_organizer_colors` WHERE `color` = 'ffffff') WHERE `field` = 'Medizin';
