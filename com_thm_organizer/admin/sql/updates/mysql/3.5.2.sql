...
VALUES
  ('BR', 'Büro', 'Office', 'Ein Raum, der vorwiegend als Büro verwendet wird.', 'A room that is primarily used as an office.', NULL, NULL ),
  ...
  ('SR.G', 'Seminarraum, groß', 'Seminar Room, Large', 'Seminarraum mit 60 Sitzplätze oder mehr. Seminarräume haben ebenen Böden und typischerweise lose Bestühlung', 'Seminar room with 60 or more seats. Seminar rooms are flat and typically have loose seating.', '60', NULL ),
  ('SR.K', 'Seminarraum, klein', 'Seminar Room, Small', 'Seminarraum mit bis zu 19 Sitzplätze. Seminarräume haben ebenen Böden und typischerweise lose Bestühlung', 'Seminar room with up to 19 seats. Seminar rooms are flat and typically have loose seating.', NULL, '19' ),
  ('SR.M', 'Seminarraum, mittel', 'Seminar Room, Medium', 'Seminarraum mit 20 bis einschließlich 59 Sitzplätze. Seminarräume haben ebenen Böden und typischerweise lose Bestühlung', 'Seminar room with 20 to 59 seats. Seminar rooms are flat and typically have loose seating.', '20', '59' ),
  ('XRM', 'Raumtyp unbekannt', 'Unknown Room Type', 'Die Kategorizierung des Raums wurde nicht ermittelt.', 'The room\'s categorization was not determined.', NULL, NULL );