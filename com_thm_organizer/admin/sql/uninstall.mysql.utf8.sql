...
DROP TABLE IF EXISTS `#__thm_organizer_course_instances`;
...
DROP TABLE IF EXISTS `#__thm_organizer_person_groups`;
DROP TABLE IF EXISTS `#__thm_organizer_person_rooms`;
