...
INSERT INTO `#__thm_organizer_colors` (`name_de`, `color`, `name_en`)
VALUES ('THM Hintergrundgruen', '#cce3a7', 'THM Hintergrundgruen'),
...
INSERT INTO `#__thm_organizer_degrees` (`name`, `abbreviation`, `code`)
VALUES ('Bachelor of Engineering', 'B.Eng.', 'BE'),
...
INSERT INTO `#__thm_organizer_fields` (`gpuntisID`, `field_de`, `colorID`, `field_en`)
VALUES ('BAU', 'Bauwesen', 9, 'Bauwesen'),
       ...
       ('ZEuUS',
        'Zentrum für Energie- und Umweltsystemtechnik',
        NULL,
        'Center for Energy and Environmental Technology');

INSERT INTO `#__thm_organizer_frequencies` (`id`, `frequency_de`, `frequency_en`)
...
INSERT INTO `#__thm_organizer_grids` (`name_de`, `name_en`, `grid`, `defaultGrid`, `gpuntisID`)
VALUES ('Haupt-Zeitraster',
        'Haupt-Zeitraster',
...
VALUES ('AÜB', 'AÜB', 'PEX', 'Anwesenheitsübung', 'Presence Exercise'),
...
INSERT INTO `#__thm_organizer_room_types` (`gpuntisID`,
                                           `name_de`,
                                           `name_en`,
                                           `description_de`,
                                           `description_en`,
                                           `min_capacity`,
                                           `max_capacity`)
VALUES ('SR.K', 'Seminarraum, Klein', 'Seminar Room, Small', '', '', NULL, 19),
