 ...
 */
class  THM_OrganizersViewResource_Room_Manager extends JView {

	function display($tpl = null)
	{
		//Create Toolbar
        JToolBarHelper::title( JText::_( 'THM - Organizer: Room Manager' ), 'generic.png' );
		...
		$filter_order		= $mainframe->getUserStateFromRequest( "$option.$view.filter_order",		'filter_order',		'#__thm_organizer_rooms.id, #__thm_organizer_rooms.name', '' );
