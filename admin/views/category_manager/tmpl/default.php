            ...
            <table class="adminlist thm_organizer_mm_table">
                <thead>
                    <tr>
                        ...
                        <th><?php echo JText::_( 'Kategorie' ); ?></th>
                        <th><?php echo JText::_( 'Beschreibung' ); ?></th>
                    </tr>
                </thead>
<?php $k = 0; if(!empty($this->categories)): foreach($this->categories as $category) :
        ...
        $k++ ?>
	        <tr class="<?php echo $class; ?>">
	            ...
	            <td class="thm_organizer_mm_ip"><?php echo $category['id']; ?></td>
	            <td class="thm_organizer_mm_ip"><?php echo $linkstart.$category['globaldisplay'].$linkend; ?></td>
	            <td class="thm_organizer_mm_room"><?php echo $linkstart.$category['reservesobjects'].$linkend; ?></td>
	        </tr>
