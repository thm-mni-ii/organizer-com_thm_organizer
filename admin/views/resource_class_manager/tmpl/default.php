 ...
 * @name        default.php
 * @description default template for the class resource manager view
 * @author      Wolf Rost
...
<table class="adminlist">
	<thead>
		<tr>
			...
			<th align="center"><?php echo JHTML::_('grid.sort',JText::_('Semester'), 'semesterName', $this->lists['order_Dir'], @$this->lists['order'] ); ?>
			</th>
			<th align="center"><?php echo JHTML::_('grid.sort', JText::_('Department'), 'dptName', $this->lists['order_Dir'], @$this->lists['order'] ); ?>
			</th>
		</tr>
	</thead>
	<?php
	...
	<tr class="<?php echo "row".$k; ?>">
		...
		<td align="center"><?php echo $row->semesterName; ?></td>
...
<input type="hidden" name="view" value="resource_class_manager" />
